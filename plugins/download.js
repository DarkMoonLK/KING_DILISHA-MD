...
cmd({
  ...
  try {
    ...
    const caption = `╭━━━〔 *𝐊𝐈𝐍𝐆_𝐃𝐈𝐋𝐈𝐒𝐇𝐀-𝐌𝐃 𝐓ᴡɪᴛᴛᴇ𝐑 𝐃ᴏᴡɴʟᴏᴀᴅᴇ𝐑* 〕━━━⊷\n`
...
cmd({
  ...
  try {
    ...
    const caption = `╭━━━〔 *𝐊𝐈𝐍𝐆_𝐃𝐈𝐋𝐈𝐒𝐇𝐀-𝐌𝐃 𝐌ᴇᴅɪᴀꜰɪʀ𝐄 𝐃ᴏᴡɴʟᴏᴀᴅᴇ𝐑* 〕━━━⊷\n`
      + `┃▸ *𝙵𝙸𝙻𝙴 𝙽𝙰𝙼𝙴:* ${file_name}\n`
      + `┃▸ *𝙵𝙸𝙻𝙴 𝚃𝚈𝙿𝙴:* ${mime_type}\n`
      + `╰━━━⪼\n\n`
...
cmd({
  ...
  try {
    ...
    const caption = `╭━━━〔 *𝐊𝐈𝐍𝐆_𝐃𝐈𝐋𝐈𝐒𝐇𝐀-𝐌𝐃 𝐀ᴘ𝐊 𝐃ᴏᴡɴʟᴏᴀᴅᴇ𝐑* 〕━━━┈⊷
┃ 📦 *𝙽𝙰𝙼𝙴:* ${app.name}
┃ 🏋 *𝚂𝙸𝚉𝙴:* ${appSize} MB
┃ 📦 *𝙿𝙰𝙲𝙺𝙰𝙶𝙴:* ${app.package}
  ...
  try {
    ...
    if (downloadUrl) {
      ...
      await conn.sendMessage(from, {
        ...
        caption: "> *★ Ｄ𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝙳 𝙱𝚈 𝙳𝙸𝙻𝙸𝚂𝙷𝙰 𝚃𝙴𝙲𝙷 ㋡*"
      }, { quoted: m });
